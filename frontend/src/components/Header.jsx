...
export default function Header({ user, onGoHome, onGoLogin, onGoLobby, onLogout, onGoProfile, onGoAdmin, onGoStudy, onGoClasses, onGoMyClasses, onOpenClass, onOpenReports, onGoTools, onGoHistory, onGoShop }) {
