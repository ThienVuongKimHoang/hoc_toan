...
export const SUBJECTS = {
  ...
  toeic: { label: 'TOEIC', icon: imgIcon('/img/toeic.webp') },
  ielts: { label: 'IELTS', icon: imgIcon('/img/ielts.webp') },
  thieunhi: { label: 'Tiếng Anh thiếu nhi', icon: imgIcon('/img/thieu_nhi.jpeg') },
